...
Initial code created by doing:
```
bsb -init react-test -theme react-starter
...
npm install
```
failed due to old and incompatible version of packages.
So we removed the dependencies from package.json and called these instead:
